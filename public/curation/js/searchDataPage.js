				...
				if(item != undefined){
					...
					$.ajax( {
                        ...
                        success: function(data) {
                            if(!data)
                            {
                               item.attributes.displaySaveButton = "block";
                               item.attributes.displayRemoveButton = "none";
                            }else{
                               item.attributes.displaySaveButton = "none";
                               item.attributes.displayRemoveButton = "block";
                            }
...
function saveItemsToBuffer(obj){
    ...
    var saveButton = urlObj.find('#saveBufferButton');
    var removeButton = urlObj.find('#removeBufferButton');
    saveBufferBySource(source,href,saveButton,removeButton);
}
...
function saveBufferBySource(source,href,saveButton,removeButton){
    $.ajax( {
        type: 'POST',
        url: apiURL + "/bufferItem",
        data: {"source":source,"href":href},
